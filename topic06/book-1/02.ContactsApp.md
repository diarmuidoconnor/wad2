...
We want to add the Google Map image to the contact details page. Ideally the map should correspond to the persons address, however the longitude and latitude readings provided by the Random User web API are ramdomly generated and are invalid for mapping purposes. 
