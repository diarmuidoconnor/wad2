...
Express gives us an easy way of mapping specific URL paths to Javascript functions. This is called **Routing**. We want to create the following API for now:

![image-20211110230159843](./img/image-20211110230159843.png)

### Movies Test Data

Initially, we'll need some test data to develop and test the functionality of the  API. 
...
In the absence of a database, this module exports a **movies, movieReviews** and **MovieDetails** object that we can use to develop and test the api.