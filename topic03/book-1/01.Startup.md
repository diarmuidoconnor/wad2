...
___Continuous Assessment (CA).__

The React app developed in this and subsequent labs is part of this module's CA. You will be committing the work done in the labs to a GitHub repository, which we assess. You are expected to complete each lab promptly, which is an integral part of the assessment criteria.

Create a repo in your GitHub account called 'labMoviesApp' and add it as a remote repo for the movies app project on your local computer, i.e. use the 'git add remote' command. Refer to the earlier labs if necessary on how to complete this step.
