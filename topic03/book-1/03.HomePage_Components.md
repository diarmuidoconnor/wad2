...
[ NOTE: We will ignore the black navigation bar at the top for now - we will address it in a future lab.]
...
+ The `Add to Favorites` button is inactive as we are only developing a static web app at this stage.
...
Storybook can help us verify our component renders correctly. In `stories/index.js`:
...
~~~
The genre list is hard-coded for now but it will be dynamically constructed in a future lab.
...
~~~
This is how the component should render in the UI:
